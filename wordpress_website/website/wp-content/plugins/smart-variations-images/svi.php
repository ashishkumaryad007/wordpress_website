        ...
        <div id="post-body" class="metabox-holder columns-1">
            ...
            ?></b>) - Recomended PHP 7+</li>
                                ...
                                <ul>
                                    ...
                                    <li>2. Go to "SVI Variations Gallery" tab and setup the galleries according to the
                                        variations you want displayed</li>
                                    <li>3. Save the product</li>
                                    <li>4. Go to WooCommerce > SVI > Global TAB and "Enable SVI" so that is works on the
                                        Front-End</li>
                                    <li>5. Good luck with sales :)</li>
                                    <li>6. What the video if have doubts:</li>
                                </ul>
                                <center><iframe width="560" height="315" src="https://www.youtube.com/embed/QMV8XBeub_o"
                                        frameborder="0"
