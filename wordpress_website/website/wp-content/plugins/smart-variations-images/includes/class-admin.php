...
<div data-dismissible="disableshowcaseslider202002-done-notice-forever" class="notice notice-warning is-dismissible">
    ...
    <p style="line-height: 1.4em;">
        ...
        echo  SVI_URL ;
        ?>/assets/img/svi.png"
            style="float: left; height: auto; margin-right: 1em; max-width: 90px;">
        ...
        <div style="margin-bottom: 20px;font-size: 14px;">Get your <strong>PRO version for just 49$</strong> go to
            <?php 
        echo  $settings_link ;
        ?>. <b>Hurry-Up!</b> It's a Limited Offer. Ending in <u><span
                    id="svilimited"></span></u>!
        </div>
        <div>Appreciate my project by leaving a review <a
                href="https://wordpress.org/support/plugin/smart-variations-images/reviews/#new-post"
