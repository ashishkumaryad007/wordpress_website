    ...
    <div class="ec_admin_important_numbered_list_fullwidth">
        <div class="ec_admin_list_line_item_fullwidth ec_admin_demo_data_line">
            ...
            <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
                ...
                <div class='updated error' style="margin-bottom:20px;"><p><strong>You are currently running a legacy Standard edition shopping cart that was End of Life as of January 1, 2020 and no longer will be updated.  You may continue to use this software, however, note that it is outdated and is no longer being updated and will continue to become outdated as WordPress and other plugins continue to update. If you wish to move to a newer software you may upgrade your edition by visiting <a href="https://www.wpeasycart.com/my-account" target="_blank">www.wpeasycart.com/my-account</a>.</strong></p></div><br />
