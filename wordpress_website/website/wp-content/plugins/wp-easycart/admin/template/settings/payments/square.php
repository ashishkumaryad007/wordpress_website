<div class="ec_admin_square_row">
    <div class="ec_admin_slider_row">
        ...
        <div id="ec_square_options" class="ec_admin_initial_hide">
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show"><?php echo apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:5px;"></span>' ); ?>Digital Wallets
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show">Merchant Name (Shown in Digital Wallet Payments)
                <input type="text" name="ec_option_square_merchant_name" id="ec_option_square_merchant_name" value="<?php echo get_option( 'ec_option_square_merchant_name' ); ?>" placeholder="Your Company Name" /> <input type="button" onclick="ec_admin_save_square_options( );" class="ec_admin_settings_simple_button" value="Save Name" style="float:left;" />
            </div>
            <?php } } ?>
        </div>
    </div>
