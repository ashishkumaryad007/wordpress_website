<div class="ec_admin_list_line_item">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_products_section">
        ...
        <div><input type="checkbox" name="ec_option_customer_review_notification" id="ec_option_customer_review_notification" value="1"<?php if( get_option( 'ec_option_customer_review_notification' ) == "1" ){ echo " checked=\"checked\""; }?> /> Notify Admin on New Review</div>
    </div>
