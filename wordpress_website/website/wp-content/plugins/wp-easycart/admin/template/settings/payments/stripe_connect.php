<div class="ec_admin_stripe_row">
    <div class="ec_admin_slider_row">
        ...
        <div class="ec_admin_slider_row_description">
            <div style="float:left; width:100%; margin-bottom:15px;">Stripe offers the ability to pay with a credit card directly on your website. Adding Stripe gives your shopping cart a more professional look and increases conversions.</div>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;"><label style="float:left; width:100%;">Currency</label>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;"><label style="float:left; width:100%;">Business Country</label>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;"><label style="float:left; width:100%;"><?php echo apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; margin-top:5px;"></span>' ); ?>Enable Apple/Google/Microsoft Pay</label>
                <select name="ec_option_stripe_enable_apple_pay" id="ec_option_stripe_enable_apple_pay" onchange="ec_admin_save_stripe_connect_options( );">
                    <option value="0" <?php if( !get_option('ec_option_stripe_enable_apple_pay' ) ) echo ' selected'; ?>>Only Available in PRO &amp; Premium</option>
                </select>
            </div>
            <div id="stripe_use_ideal" class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important; font-size:12px;<?php if( get_option( 'ec_option_stripe_currency' ) != 'EUR' ){ echo ' display:none;'; } ?>"><label style="float:left; width:100%;">Enable iDEAL (the most popular payment method in the Netherlands)</label>
        ...
        <div class="ec_admin_webhook"><strong>To Do:</strong> You must add the Webhook URL to your Stripe account for best results. <a href="http://docs.wpeasycart.com/wp-easycart-administrative-console-guide/?section=stripe" target="_blank">Click Here to Learn More</a></div>
     	<?php }?>
    </div>
</div>