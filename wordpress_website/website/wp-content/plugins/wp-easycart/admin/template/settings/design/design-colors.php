<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div>
        <span class="ec_colorizer_row_label">Admin Color Scheme: </span>
        <span class="ec_colorizer_row_input"><input type="color" name="ec_option_admin_color" id="ec_option_admin_color" value="<?php echo get_option( 'ec_option_admin_color' ); ?>" class="ec_color_block_input" style="width:45px;" /></span>
    </div>
