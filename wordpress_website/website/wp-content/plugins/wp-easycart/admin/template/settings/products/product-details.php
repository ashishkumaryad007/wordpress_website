<div class="ec_admin_list_line_item">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_products_section">
        ...
        <div><input type="checkbox" name="ec_option_show_stock_quantity" id="ec_option_show_stock_quantity" value="1"<?php if( get_option('ec_option_show_stock_quantity') == "1" ){ echo " checked=\"checked\""; }?> /> Show Stock Quantity (Caution! Disabling This Turns OFF ALL Quantity Tracking!)</div>
