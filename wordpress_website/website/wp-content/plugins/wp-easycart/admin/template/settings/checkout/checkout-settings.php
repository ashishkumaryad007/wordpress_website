<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
        ...
        <div>Custom Continue Shopping URL (leave blank to automatically redirect to store)<input name="ec_option_return_to_store_page_url" id="ec_option_return_to_store_page_url" type="text" value="<?php echo get_option( 'ec_option_return_to_store_page_url' ); ?>" /></div>
