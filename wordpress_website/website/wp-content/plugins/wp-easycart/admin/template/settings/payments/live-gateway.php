<div class="ec_admin_list_line_item">
    ...
    <div class="ec_admin_stripe_holder">
        ...
        <div class="ec_admin_stripe_button_row">
            ...
            <?php }else{ ?>
            <a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production' ); ?>&env=production">Switch to Live Mode</a><?php }?> | <a href="admin.php?page=wp-easycart-settings&subpage=payment&ec_admin_form_action=stripe-connect-sandbox-disconnect">Change Payment Method</a>
        </div>
    	...
    	<div class="ec_admin_settings_notice" style="text-align:center; padding:0 10px 20px;"><strong>To Do:</strong> You must add the Webhook URL to your Stripe account for best results. <a href="http://docs.wpeasycart.com/wp-easycart-administrative-console-guide/?section=stripe" target="_blank">Click Here to Learn More</a></div>
    </div>
    ...
    <div class="ec_admin_stripe_holder">
        ...
        <div class="ec_admin_stripe_button_row">
            ...
            <?php }else{ ?>
            <a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox' ); ?>&env=sandbox">Switch to Sandbox Mode</a><?php }?> | <a href="admin.php?page=wp-easycart-settings&subpage=payment&ec_admin_form_action=stripe-connect-production-disconnect">Change Payment Method</a>
        </div>
        <div class="ec_admin_stripe_legal">*WP EasyCart charges a 2% application fee on all sales with Stripe in the free edition.</div>
    	<div class="ec_admin_settings_notice" style="text-align:center; padding:0 10px 20px;"><strong>Webhook URL:</strong> <?php echo plugins_url( EC_PLUGIN_DIRECTORY . "/inc/scripts/stripe_webhook.php" ); ?></div>
    </div>
    ...
    <div class="ec_admin_stripe_holder">
        ...
        <div class="ec_admin_stripe_button_row">
            ...
            <br />
            <a href="https://connect.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox' ); ?>&env=sandbox">Try Sandbox First?</a>
        </div>
        <div class="ec_admin_stripe_legal">*WP EasyCart charges a 2% application fee on all sales with Stripe in the free edition.</div>
