    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
    	...
    	<?php
			...
			if( strstr( get_option( 'permalink_structure' ), '%postname%' ) === FALSE ) {?>
                <div class="ec_status_subtitles"><div class="dashicons-before dashicons-warning"></div>Not using Post Name permalinks, which could have negative effects on your store. Edit this in your Settings -> Permalinks</div><?php 
			} else {?>
				<div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>Post Name permalinks in use</div><?php
			}
            ...
            if( !class_exists( 'SimpleXMLElement' ) ){
                ...
                <div class="ec_status_subtitles"><div class="dashicons-before dashicons-warning"></div>Your live shipping setup requires the PHP extension SimpleXMLElement to function correctly. Please contact your host to enable this feature.</div>   
                <?php }else{ ?>
                <div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>Some live shipping requires the SimpleXMLElement php extension. Currently this is not a problem, but if you add one of the live shippers that requires this, you may have problems.</div>
                <?php }
            }else{ ?>
                <div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>SimpleXMLElement installed.</div>
            <?php }
		?>
        </div>
        <?php
