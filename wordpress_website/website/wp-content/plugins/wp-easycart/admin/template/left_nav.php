...
<!--<div class="ec_admin_left_nav_item ec_admin_default_color2-border ec_admin_default_color1-background-gradient<?php if( isset( $_GET['page'] ) && $_GET['page'] == "wp-easycart-reports" ){ ?> ec_admin_left_nav_selected<?php }?>">
...
<!--EXTENSIONS-->
<!--<div class="ec_admin_left_nav_item ec_admin_default_color2-border ec_admin_default_color1-background-gradient<?php if( isset( $_GET['page'] ) && $_GET['page'] == "wp-easycart-extensions" ){ ?> ec_admin_left_nav_selected<?php }?>">
