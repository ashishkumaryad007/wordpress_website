function ec_admin_save_checkout_form_options( ){
	...
	var ec_option_user_phone_required = 0;
	...
	if( jQuery( document.getElementById( 'ec_option_user_phone_required' ) ).is( ':checked' ) )
	...
	var data = {
		...
		ec_option_user_phone_required: ec_option_user_phone_required,
