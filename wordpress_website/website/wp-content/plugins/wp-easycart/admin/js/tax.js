...
function ec_admin_update_vat_tax_rate( ){
	...
	var data = {
		...
		ec_option_no_vat_on_shipping: ec_admin_get_value( 'ec_option_no_vat_on_shipping', 'checkbox' ),
		ec_option_vat_custom_rate: ec_admin_get_value( 'ec_option_vat_custom_rate', 'text' ),
...
function ec_admin_update_canada_tax_rate( ){
	...
	jQuery( '.ec_admin_canada_tax_gst_input' ).each( function( index ){
		...
		data[jQuery( this ).attr( 'name' )] = tax_amount;
	} );
