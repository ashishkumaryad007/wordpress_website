...
final class wp_easycart_admin_taxes{
	...
	public function save_vat_tax_rate( ){
		...
		$vat_added = 0;
		$vat_included = 0;
		$ec_option_vat_custom_rate = $_POST['ec_option_vat_custom_rate'];
		$ec_option_no_vat_on_shipping = 1;
		...
		if( isset( $_POST['ec_option_no_vat_on_shipping'] ) && $_POST['ec_option_no_vat_on_shipping'] == 1 )
			$ec_option_no_vat_on_shipping = 0;
		...
		update_option( 'ec_option_vat_custom_rate', $ec_option_vat_custom_rate );
        update_option( 'ec_option_no_vat_on_shipping', $ec_option_no_vat_on_shipping );
